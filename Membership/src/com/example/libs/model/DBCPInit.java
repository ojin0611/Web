...
public class DBCPInit extends HttpServlet {
	...
	private final String url = "jdbc:oracle:thin:@www.example.com:1521:XE";
	...
	private void initconnectionPool() {
		try {
			...
			ConnectionFactory connFactory = new DriverManagerConnectionFactory(this.url,
			...
			PoolableConnectionFactory poolableConnFactory = new
